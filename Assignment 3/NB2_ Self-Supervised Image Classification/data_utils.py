...
def compute_train_transform(seed=123456):
    ...
    train_transform = transforms.Compose([
        ...
        transforms.RandomHorizontalFlip(0.5), #https://docs.pytorch.org/vision/0.9/transforms.html
        # Step 3: With a probability of 0.8, apply color jitter (you can use "color_jitter" defined above.
        transforms.RandomApply([color_jitter], p=0.8), #first arg must be a list/tuple
